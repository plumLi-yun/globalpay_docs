...
> 
> 2、金额单位为<span style="color:red;"> 分（库鲁什） </span>。
> 
> 3、请求接口的 IP 需要加白。
> 
...
| order_no     | string | true  | 商户订单号                                                                                                  |
| dis_order_no | string | true  | 平台订单号                                                                                                  |
| order_price  | int    | true  | 订单金额,单位:库鲁什                                                                                              |
| <span style="color:red;">real_price</span>   | int    | true  | <span style="color:red;">用户真实付款金额 ,单位:库鲁什</span>                                                                                         |
...
``
{"first_name":"名","last_name":"姓","email":"邮箱"}
``

| 名称       | 类型     | 必填   | 描述             |
|----------|--------|------|----------------|
| first_name    | string    | true | 名         |
| last_name    | string    | true | 姓         |
...
| trade_no     | int    | true  | 商户号                                                                                                                                             |
| <span style="color:red;">real_price</span>   | int    | true  | <span style="color:red;">真实付款金额 ,单位:库鲁什</span>                                                                                                                                     |
...
| code    | int    | true | 200:查询成功 其他:失败      |
| msg     | string | true | 失败原因                   |
| balance | int    | true | 余额,单位:库鲁什               |
| balance_frozen | int    | false | 冻结余额,单位:库鲁什               |
| sign    | string | true | 签名结果,签名方法在文档顶部 |
...
| order_no       | string | true  | 商户订单号                     |
| amount       | string | true  | 商户金额单位土耳其里拉                    |
