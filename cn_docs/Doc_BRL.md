...
| pay_info  | string    | false | 付款信息 {"utr2":"*****"}           |
...
| fee          | int    | false | 订单手续费 ,单位:分                                                                                                                                       |
| create_time  | int    | true  | 创建时间                                                                                                                                              |
| payer        | string | false | JSON 字符串,付款人信息{"account_name":"姓名","account_type":"账号类型:CPF,CNPJ,EMAIL,PHONE,EVP","account_no":"账号","identify_type":"证件类型","identify_num":"CPF,CNPJ","bank_code":"银行编码"} |
...
| 字段      | 国家   | 值         | 描述                |
|-----------|------|-----------|-------------------|
| pay_method | 巴西   | pix       | PIX  -需要用户名、cpf等信息           |
| pay_method | 巴西   | PIX1       | PIX 非实名           |
