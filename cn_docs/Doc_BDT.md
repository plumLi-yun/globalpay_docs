...
>
> 2、金额单位为 <span style="color:red;">派沙（Poisha）</span>  。
>
> 3、请求接口的 IP 需要加白。
>
...
| price          | int    | true  | 下单金额，单位：<span style="color:red;">派沙（Poisha）</span>，整型 1塔卡（Taka） = 100 派沙（Poisha） |
...
| phone       | string | false | 手机号   `建议填写` 01开头的11位                              |
...
| order_no     | string | true  | 商户订单号                                                                                                  |
| dis_order_no | string | true  | 平台订单号                                                                                                  |
| order_price  | int    | true  | 订单金额,单位:<span style="color:red;">派沙（Poisha）</span>                                                                                              |
| <span style="color:red;">real_price</span>   | int    | true  | <span style="color:red;">用户真实付款金额 ,单位:派沙（Poisha）</span>                                                                                         |
...
| app_id         | int    | true  | 商户 appId                                                          |
| pay_code       | int    | true  | 产品编码,联系我方运营获取                                                     |
| price          | int    | true  | 下单金额，单位：<span style="color:red;">派沙（Poisha）</span> ，整型            |
| account_no     | string | true  | 收款账号 eg:01880612345                                            |
...
| trade_no     | int    | true  | 商户号                                                                 |
| <span style="color:red;">real_price</span>   | int    | true  | <span style="color:red;">真实付款金额</span>                                                     |
...
| order_no       | string | true  | 商户订单号        |
| amount       | string | true  | 商户金额单位 `塔卡（Taka）` |
