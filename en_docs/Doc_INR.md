...
| pay_info   | string | false  | Payment information JSON string. e.g., {"pay_raw":"Native payment information, which merchants can convert into a QR code themselves","phone":"phonepe wake-up link","google":"google wake-up link","paytm":"paytm wake-up link","mobik":"mobik wake-up link","bhim":"bhim wake-up link","upi":"upiLink"} |
| sign     | string | true   | Signature result, see the top of the document for the signature method.                    |
...
| <span style="color:red;">real_price</span>  | int  | true   | <span style="color:red;">Actual amount paid by the user, unit: Paise.</span>                                                                                                             |
...
| trade_no   | int  | true   | Merchant ID.                                                                                                 |
| <span style="color:red;">real_price</span>  | int  | true   | <span style="color:red;">Actual amount paid, unit: Paise.</span>                                                                                       |
