...
>
> 2. The currency unit is <span style="color:red;"> centimos </span>.
>
...
| pay_method   | string | true   | Payment method, fixed value: peru.                                                                                  |
...
| attach     | string | true   | Additional parameters in JSON string format: {"account_no":"","account_type":"","name":"Name","identify_type":"ID Type","identify_num":"ID Number"}.                          |
...
```json
{
 ...
 "attach": "{\"name\":\"Zhang San\",\"identify_type\":\"\",\"identify_num\":\"\"}",
...
| pay_info   | string | false  | Payment information JSON string. e.g., {"pay_raw":"Native payment information","redirect_url":"Payment redirect URL"} |
| sign     | string | true   | Signature result, see the top of the document for the signature method.                    |
...
| payer    | string | false  | JSON string, payer info: {"name":"Name", "account":"Account", "bank":"User Bank Code", "utr2":"Bank serial number", "email":"Email", "phone":"Phone", "identify_type":"Identity Type", "identify_num":"ID Number"}. Also includes payer-related fields from `attach`. |
...
If the callback is successfully received and processed, please return `success`. The system will stop pushing this order information; otherwise, it will resend it multiple times.
...
| bank_code   | string | true   | Bank code: To be provided.                          |
| identify_type | string | true   | Identity type: To be provided.           |
| identify_num  | string | true   | Identity number: To be provided.           |
...
| fee     | int  | false  | Order fee, unit: Centimos.                                                                                           |
| create_time | int  | true   | Creation time.                                                                                                |
| payer    | string | false  | JSON string, payer info: {"account_name":"Name", "account_type":"Account Type", "account_no":"Account", "identify_type":"Identity Type", "identify_num":"ID Number"}.       |
| pay_info   | string | false  | Payment information JSON string. e.g., original pay-in/pay-out info, card number, name, bank, etc.                                                      |
| sign     | string | true   | Signature result, see the top of the document for the signature method.                                                                   |
...
```json
{
 ...
 "payer": "{\"name\":\"Name\",\"email\":\"Email\",\"phone\":\"Phone\",\"identify_type\":\"Identity Type\",\"identify_num\":\"ID Number\"}",
 "sign": "db3406277185f9660b3b928d6adc7bc4"
}
```
...
# 13. Pay-in Payment Methods - Field `pay_method`
...
# 14. Pay-Out Payment Methods - Field `attach.pay_type`

| Field Name | Value | Description |
|-----------|-------|-------------|
| pay_type | BANK_TRANSFER | Bank transfer |
| pay_type | QR | QR payment |
