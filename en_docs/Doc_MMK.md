...
> 
> 2. The currency unit is <span style="color:red;"> Pya </span>.
> 
...
| attach     | string | false   | Additional parameters in JSON string format: {"name":"Name"} (Recommended).     |
...
> Request address: https://{api_domain}/api/v1/payApi/BackUtr
...
| <span style="color:red;">real_price</span>  | int  | true   | <span style="color:red;">Actual amount paid by the user, unit: Pya.</span>                                                                                            |
...
| trade_no   | int  | true   | Merchant ID.                                                                                                 |
| <span style="color:red;">real_price</span>  | int  | true   | <span style="color:red;">Actual amount paid, unit: Pya.</span>                                                                                       |
...
| order_no  | string | true   | Merchant order number.       |
| amount   | string | true   | Merchant Amount (Unit: Burmese Kyat) |
